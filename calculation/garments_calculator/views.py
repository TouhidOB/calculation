...
def cino_long_2(request):    
    ...
    if request.method == 'POST':
        try:
            ...
            front_thigh_width = (hip_width + thigh_hip_width) - 1.2
            front_knee_width = knee_width - 2.5
            net_front_pattern_width = front_thigh_width + front_knee_width
            net_front_pattern_width_inch = ((front_thigh_width / 2.54) + 1) + ((front_knee_width / 2.54) + 1)
            net_front_pattern_in_inch_with_shirnkage = (net_front_pattern_width_inch * shrinkage_width_percent) + net_front_pattern_width_inch
            ...
            print("front_thigh_width", front_thigh_width)
            print("front_knee_width", front_knee_width)
            print("net_front_pattern_width", net_front_pattern_width)
            print("net_front_pattern_width_inch", net_front_pattern_width_inch)
            print("net_front_pattern_in_inch_with_shirnkage", net_front_pattern_in_inch_with_shirnkage)
            ...
            belt_loop = 0.01
            button_fly = 0.02
            total_cutting_consumtion = total_body_consumption + round_waistband + back_welt + pocket_seam + belt_loop + button_fly
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_2.html', context)

    return render(request, 'garments_calculations/cino_long_2.html', context)



def cino_long_3(request):
    context = {}
    ...
    if request.method == 'POST':
        try:
            ...
            total_body_consumption = front_consumption + back_consumption
            round_waistband = (((((waist_relaxed / 2.54) * 2) + 4.75) * ((waistband_height / 2.54) + 1) / 36) * 2) / fabric_width
            back_welt = 0.006 / fabric_width * 56
            pocket_seam = 0.055
            belt_loop = 0.01
            zipper_fly = 0.01
            total_cutting_consumtion = total_body_consumption + round_waistband + back_welt + pocket_seam + belt_loop + zipper_fly
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_3.html', context)

    return render(request, 'garments_calculations/cino_long_3.html', context)



def cino_long_4(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_4.html', context)

    return render(request, 'garments_calculations/cino_long_4.html', context)



def cino_long_5(request):
    context = {}
    ...
    if request.method == 'POST':
        try:
            ...
            back_consumption = ((net_back_pattern_shrinkage * net_front_pattern_with_shrinkage) / 36) / fabric_width
            total_body_consumption = front_consumption + back_consumption
            round_waistband = (((((((waist_relaxed / 2.54) * 2) + 4.75) * ((waistband_height / 2.54) + 1) / 36) * 2) / fabric_width) / 2) + 0.01
            back_welt = 0.006 / fabric_width * 56
            pocket_seam = 0.055
            belt_loop = 0.01
            zipper_fly = 0.01
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_5.html', context)

    return render(request, 'garments_calculations/cino_long_5.html', context)



def cino_long_6(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_6.html', context)

    return render(request, 'garments_calculations/cino_long_6.html', context)



def cino_long_7(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_7.html', context)

    return render(request, 'garments_calculations/cino_long_7.html', context)



def cino_long_8(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_8.html', context)

    return render(request, 'garments_calculations/cino_long_8.html', context)



def cino_long_9(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_9.html', context)

    return render(request, 'garments_calculations/cino_long_9.html', context)



def cino_long_10(request):
    context = {}
    ...
    if request.method == 'POST':
        ...
        context['form_data'] = request.POST
        return render(request, 'garments_calculations/cino_long_10.html', context)
